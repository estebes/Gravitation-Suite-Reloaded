package com.estebes.gravisuitereloaded.reference;
...
public class Reference {
    ...
    public static final String VERSION = "1.7.10-special";
    ...
    // Resource
    public static final String CUTTING_BLADE_IRIDIUM_NAME = "ItemCuttingBladeIridium";
